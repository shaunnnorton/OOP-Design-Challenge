...
#------------------------------------------------------------------------------------------------------------------------------------
    def detect_collision(self,object,counter):
        ...
        if(self.__position[0]+self._offset_X in range(object.position[0],object.position[0]+object._dimensions[0]) and round(self.__position[1],0)+self._offset_Y in range(object.position[1],object.position[1]+object._dimensions[1])):
            counter+=1
            self.__position = [random.randint(self._offset_X, 800-self._offset_X),random.randint(-200,self._offset_Y)]
            return counter
